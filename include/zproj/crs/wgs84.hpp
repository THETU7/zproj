...
inline constexpr double kEccentricitySquared = kFlattening * (2.0 - kFlattening);  // e^2
inline constexpr double kSemiMinorAxis = kSemiMajorAxis * (1.0 - kFlattening);     // b
}  // namespace wgs84
...
ZPROJ_HD inline Ecef to_ecef(const Geodetic& g) noexcept
{
    ...
    const double N = kSemiMajorAxis / sqrt(1.0 - kEccentricitySquared * sin_lat * sin_lat);
    return Ecef{
